...
\cventry{2013.08--2013.10}{\mdseries 2013年第15届清华大学电子设计竞赛官方网站制作}{}{}{}{
  独立完成前端和后端的实现。网站包含选手和团队报名、赛事预告、文档下载和选手论坛，为比赛主办方继续沿用。\\
  语言：Ruby
}
...
\vspace{0.3cm}
\cventry{2014.10--2015.01}{\mdseries 利用Docker和OpenBTS搭建虚拟GSM基站池}{}{NiuLab}{}{
...
\section{编程语言}
\cvitem{精通}{C++，Shell，Python，Javascript}
\cvitem{熟悉}{Java，Ruby}

\section{相关能力}
\cvitem{Linux}{有4年Linux环境的工作经验}
